...
import com.epaymark.epay.databinding.FragmentBalenceAepsBinding
...
class BalenceAEPSFragment : BaseFragment() {
    lateinit var binding: FragmentBalenceAepsBinding
    private val viewModel: MyViewModel by activityViewModels()
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_balence_aeps, container, false)
